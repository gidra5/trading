  ...
  await Promise.all([
    ...
    writeFile(path.join(derivedRunDir, "state", "status.json"), JSON.stringify({
      ...
      latest: {
        ...
        batches: 100,
        bestTrainScore: 0.25,
        onlineNegativeLogLikelihood: -12.5,
        onlineTrain: {
          normalizedMse: 0.9,
          mseSkillVsZero: 0.1,
        ...
        "validation-mse": {
          ...
          pointVariants: {
            "cubic-log": {
              ...
              inputScale: 0.1,
              outputScale: 0.2,
              coefficients: [0.01, 0.2, -0.03, 0.004],
              calibration: { normalizedMse: 0.95 },
              validation: { normalizedMse: 0.97 },
              test: { normalizedMse: 1.03 },
              calibrationPerLead: [{ mseSkillVsZero: 0.04 }],
              validationPerLead: [{ mseSkillVsZero: 0.03, correlation: 0.08 }],
              testPerLead: [{ mseSkillVsZero: 0.02, correlation: 0.07 }],
            },
          },
          pointWindowVariants: {
            "8000": {
              "affine-arithmetic": {
                label: "Affine · arithmetic returns",
                domain: "arithmetic",
                degree: 1,
                calibrationWindow: 8000,
                validation: { mseSkillVsZero: 0.012 },
                test: { mseSkillVsZero: 0.009 },
              },
            },
          },
        },
      ...
      runs: [{
        ...
        fit: [
          { epoch: 120, validationNormalizedMse: 1.1 },
          {
            ...
            onlineTrainNegativeLogLikelihood: -12.5,
          },
          {
            epoch: 127,
            train: { normalizedMse: 0.25, mseSkillVsZero: 0.75 },
            trainNormalizedMse: 0.25,
          },
        ],
      }],
    });
