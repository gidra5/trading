...
MATRIX_ID = "nonzero-target-scaling-v1"
VARIANT_SUFFIX = "nonzero-targets-v1"
PAUSE_EXIT_CODE = 75
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run the six standard model/data scaling diagnostics after "
            "excluding exact-zero next-return targets everywhere."
        )
    )
