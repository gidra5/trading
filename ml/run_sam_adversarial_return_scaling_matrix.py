...
MATRIX_ID = "sam-adversarial-return-scaling-rho05-eps05-1024epoch-v1"
SAM_RHO = 0.5
ADVERSARIAL_EPSILON_RMS = 0.5
ATTACK_STEPS = 1
ADVERSARIAL_WEIGHT = 0.5
EPOCHS = 1024
VARIANT_SUFFIX = "sam-rho-5e-1-return-eps-5e-1-1024epoch-v1"
PAUSE_EXIT_CODE = 75
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run six model/data scaling diagnostics with SAM rho 0.5 and "
            "joint input/output log-return perturbation epsilon RMS 0.5."
        )
    )
    ...
    for base_plan in BASE_PLANS:
        ...
        commands = (
            ((
                ...
                "--sam-rho",
                str(SAM_RHO),
                "--adversarial-return-vector-epsilon-rms",
                str(ADVERSARIAL_EPSILON_RMS),
                "--adversarial-return-vector-steps",
                str(ATTACK_STEPS),
                "--adversarial-return-vector-weight",
