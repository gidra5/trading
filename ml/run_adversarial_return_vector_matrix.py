...
MATRIX_ID = "adversarial-return-vector-screen-v1"
EPSILON_RMS_VALUES = (
    (0.01, "1e-2"),
    (0.03, "3e-2"),
    (0.1, "1e-1"),
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Screen joint adversarial perturbations of 120 input log returns "
            "and the following output log return."
        )
    )
...
def main() -> None:
    ...
    for epsilon_rms, epsilon_label in EPSILON_RMS_VALUES:
        suffix = f"adversarial-return-vector-eps-{epsilon_label}-v1"
