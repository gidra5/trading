...
MATRIX_ID = "robust-regression-screen-v1"
LOSS_VARIANTS = (
    ("huber", 0.5, "huber-delta-5e-1-v1"),
    ("huber", 1.0, "huber-delta-1e0-v1"),
    ("huber", 2.0, "huber-delta-2e0-v1"),
    ("student-t", 1.0, "student-t-nu-1-v1"),
    ("student-t", 3.0, "student-t-nu-3-v1"),
    ("student-t", 10.0, "student-t-nu-10-v1"),
)
PAUSE_EXIT_CODE = 75
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Screen robust losses on the fast four-layer 65k diagnostic."
    )
...
def main() -> None:
    ...
    for loss_type, parameter, suffix in LOSS_VARIANTS:
