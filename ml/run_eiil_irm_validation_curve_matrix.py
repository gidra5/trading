...
MATRIX_ID = "nonzero-eiil-irm-validation-curves-v1"
REFERENCE_SUFFIX = "nonzero-clean-count-validation-curve-v1"
EIIL_SUFFIX = "nonzero-eiil-irmv1-validation-curve-v1"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run six clean-count ERM/EIIL pairs with a fixed held-out "
    ...
    for base_plan_name in BASE_PLANS:
        ...
        commands = (
            ((
                ...
                "--variant-suffix", REFERENCE_SUFFIX,
                *validation_arguments,
            ...
            ((
                sys.executable,
                str(evaluator),
                "--training-plan", str(reference_snapshot),
            ...
            ((
                ...
                str(trainer),
                "--plan", str(source_plan_file),
                "--eiil-reference-plan", reference_plan_argument,
                "--variant-suffix", EIIL_SUFFIX,
                *validation_arguments,
                "--pause-file", str(pause_file),
            ...
            ((
                sys.executable,
                str(evaluator),
                "--training-plan", str(eiil_root / "state/plan.json"),
                "--split-plan", str(split_plan),
                "--split", "validation",
                "--batch-size", "8192",
